...
class VideoIndexerService:
    def __init__(self):
        ...
        self.vi_name = os.getenv("AZURE_VI_NAME", "Compliance-QA-Project")
    ...
    # New Function: Download the YouTube Video
    def download_youtube_video(self, url, output_path):
        ...
        ## Upload Function: Upload Local File
    def upload_video(self, video_path, video_name):
        ...
        logger.info(f"Uploading file {video_path} to Azure...")
            ...
            # Open the file in binary mode and steam it to Azure
